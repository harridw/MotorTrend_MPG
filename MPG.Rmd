...
```{r dataset_overview, include = TRUE, echo = TRUE, results = "markup"}
str(mtcars)
head(mtcars)
```
...
```{r slr_mpg_am, include = TRUE, echo = TRUE, results = "markup"}
...
```{r mlr_am_plus_two, include = TRUE, echo = TRUE, results = "markup"}
...
```{r mlr_am_plus_three, include = TRUE, echo = TRUE, results = "markup"}
...
```{r slr_mpg_am_nine, include = TRUE, echo = TRUE, results = "markup"}
