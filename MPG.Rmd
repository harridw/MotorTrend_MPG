...
To provide additional perspective on the strength of the model in predicting, a comparison of the actual MPG to the fitted mpg and associated 95% confidence interval (see Appendix: Figure 4) to look at how well the model estimated results.  While there are a few instances (see Appendix: Figure 5) where the actual MPG falls outside the 95% confidence interval, a majority fit the model.
...
```{r corr_matrix_grid, fig.keep = "high", fig.show = "asis", fig.height = 4, fig.path = 'figure/'}
