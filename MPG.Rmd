...
```{r corr_figure, include = FALSE, ehco = FALSE, fig.keep = "high", fig.show = "hide", fig.height = 4, fig.path = 'figure/'}
corrplot(mtcars.cor, method = "number", type = "upper", add = FALSE, 
                   order = "original", is.corr = TRUE)
```

### Figure 3: Regression Model Residuals
```{r plot_residuals, include=TRUE, echo=FALSE, fig.keep="high", fig.show="asis", fig.height = 4, fig.path='figure/'}
par(mfrow = c(2,2))
plot(fit4, which = 1:4)
```


### Figure 4: Regression Model Observations outside Confidence Interval
